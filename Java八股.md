...
### LangChain/LangGraph/DeepAgent的区别是什么？
...
- LangGraph天生支持并行地计算节点。在LangChain中，我们需要手动调用`RunnableParallel`来声明节点可以并行计算；而LangGraph可以自动检测图中的依赖关系，只要没有依赖关系，就能自动并行地计算节点。
...
- Agent
	...
	- [Agentic - Claude Code v2.1.88 深度技术剖析](https://plain-sun-1ffe.hunshcn429.workers.dev/)
