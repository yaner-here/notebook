...
| WAF       | 雷池(safeline)          | C++        | ❌        | https://github.com/chaitin/safeline                    |
| WebSSH    | Eternal Terminal      | C++        | ❌        | https://eternalterminal.dev/download/                  |
...
| 文件分享      | Pingvin Share         | Node.js    | ✅        | https://github.com/stonith404/pingvin-share            |
| 文件分享      | FileCodeBox           | Python     | ✅        | https://github.com/vastsa/FileCodeBox                  |
...
| 翻墙        | Xray配置脚本              | Bash       | ❌        | https://github.com/233boy/Xray                         |
| 网络抓包      | ProxyPin              | Flutter    |          | https://github.com/wanghongenpin/network_proxy_flutter |
| 翻墙        | 多协议配置脚本               | Bash       | ❌        | https://github.com/mack-a/v2ray-agent                  |
| 翻墙        | VPN多协议配置GUI           | EXE/ELF    | ❌        | https://myvpn.run/                                     |
| 记账        | Actual                | Node.js    | ✅        | https://github.com/actualbudget/actual                 |
