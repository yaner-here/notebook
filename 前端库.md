...
| --------- | --------------------- | ---------- | -------- | ------------------------------------------------------ |
| Dashboard | Grafana               | Gr         | ✅        | https://github.com/grafana/grafana                     |
| GPT       | Lobe Chat             | Lobe Ch    | ✅        | https://github.com/lobehub/lobe-chat/                  |
| GPT       | Lepton AI             | Lepton     |          | https://www.lepton.ai/                                 |
| Git       | Gitness               | Gi         | ✅        | https://github.com/harness/gitness.git                 |
| LLM应用     | Flowise               | Flowise    | ✅        | https://github.com/FlowiseAI/Flowise                   |
| PDF工具     | Stirling-PDF          | Stir       | ✅        | https://github.com/Stirling-Tools/Stirling-PDF         |
| RSS推送     | RSSPush               |            | ✅        | https://github.com/easychen/rsspush                    |
| Torrent   | torrent               | to         |          | https://github.com/anacrolix/torrent                   |
| WAF       | 雷池(safeline)          | 雷池(        | ❌        | https://github.com/chaitin/safeline                    |
| WebSSH    | Eternal Terminal      | Ete        | ❌        | https://eternalterminal.dev/download/                  |
| 反向代理      | Nginx Proxy Manager   |            | ✅        | https://www.youtube.com/watch?v=P3imFC7GSr0            |
| 可用性监控     | Uptime Kuma           | Uptime     | ✅        | https://github.com/louislam/uptime-kuma                |
| 可用性监控     | Kener                 | Kener      | ❌        | https://kener.ing/                                     |
| 图床        | PicList               | PicList    | ✅        | https://github.com/Kuingsmile/PicList                  |
| 图片压缩      | ImgUltraCompress      | ImgUltraCo |          | https://github.com/youshandefeiyang/ImgUltraCompress   |
| 图片压缩      | Squoosh               | Squoosh    | ❌        | https://github.com/GoogleChromeLabs/squoosh            |
| 图片背景移除    | BackgroundRemover     | Backgr     |          | https://github.com/nadermx/backgroundremover           |
| 图片背景移除    | background-removal-js | background |          | https://github.com/imgly/background-removal-js         |
| 备忘录       | memos                 | me         | ✅        | https://github.com/usememos/memos                      |
| 导航页       | Sun-Panel             | Sun-Pan    | ✅        | https://github.com/hslr-s/sun-panel/                   |
| 导航页       | Dashy                 | Dashy      | ✅        | https://github.com/Lissy93/dashy                       |
| 数据表单管理    | Baserow               | Baserow    | ✅        | https://baserow.io/                                    |
| 文件分享      | Pingvin Share         | Pingvin    | ✅        | https://github.com/stonith404/pingvin-share            |
| 文件分享      | FileCodeBox           | FileCo     | ✅        | https://github.com/vastsa/FileCodeBox                  |
| 文件传输      | transfer.zip          | transfer.z | ✅        | https://github.com/robinkarlberg/transfer.zip-web      |
| 文档管理      | Paperless-ngx         | Paperl     | ✅        | https://github.com/paperless-ngx/paperless-ngx         |
| 短链接       | YOURLS                | YOU        | ❌        | https://yourls.org/                                    |
| 硬盘健康监控    | Scrutiny              |            | ✅        |                                                        |
| 网页存档      | Huntly                | Hunt       | ✅        | https://github.com/lcomplete/huntly                    |
| 自动化       | activepieces          | activep    | ✅        | https://github.com/activepieces/activepieces           |
| 面板        | 1Panel                | 1P         | ❌        | https://github.com/1Panel-dev/1Panel                   |
| 项目管理      | Plane                 |            | ✅        | https://github.com/makeplane/plane?tab=readme-ov-file  |
| 翻墙        | Xray配置脚本              | Xray       | ❌        | https://github.com/233boy/Xray                         |
| 网络抓包      | ProxyPin              | ProxyPi    |          | https://github.com/wanghongenpin/network_proxy_flutter |
| 翻墙        | 多协议配置脚本               | 多协议配       | ❌        | https://github.com/mack-a/v2ray-agent                  |
| 翻墙        | VPN多协议配置GUI           | VPN多协议配    | ❌        | https://myvpn.run/                                     |
| 记账        | Actual                | Actual     | ✅        | https://github.com/actualbudget/actual                 |
